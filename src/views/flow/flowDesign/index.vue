<template>
	<div class="FlowDesign-container">
		...
		<AddFlowDesign ref="addRef" />
		<EditFlowDesign ref="editRef" />
	</div>
</template>
...
import AddFlowDesign from '/@/views/flow/flowDesign/component/add.vue';
import EditFlowDesign from '/@/views/flow/flowDesign/component/edit.vue';
import { selectPage, deleteById } from '/@/api/flow/flowDesign';
export default {
	name: 'FlowDesign',
	components: { AddFlowDesign, EditFlowDesign },
	setup() {
		const addRef = ref();
		const editRef = ref();
