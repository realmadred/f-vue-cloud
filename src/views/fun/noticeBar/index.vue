	...
	<div class="notice-bar-container">
		<el-card shadow="hover" header="滚动通知栏：默认">
			<NoticeBar
				...
				的后台开源免费模板库（vue2.x请切换vue-prev-admin分支），仓库地址：https://gitee.com/realmadridlf/f-vue-cloud"
			/>
		</el-card>
	...
	setup() {
		const state = reactive({
			noticeList: [
				...
				'仓库地址：https://gitee.com/realmadridlf/f-vue-cloud',
				'演示地址：https://lyt-top.gitee.io/f-vue-cloud-preview/#/login',
			],
			tableData: [
				{
					a1: 'mode',
