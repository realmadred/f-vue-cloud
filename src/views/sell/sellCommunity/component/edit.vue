<template>
	<div class="add-SellCommunity-container">
		<el-dialog title="编辑小区" v-model="isShowDialog" width="769px">
			<el-form :model="ruleForm" :rules="rules" ref="form" size="small" label-width="90px">
				<el-row :gutter="35">
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="小区名称" prop="name">
							<el-input v-model="ruleForm.name" placeholder="请输入小区名称" maxlength="32" clearable/>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
import { update, SellCommunity } from '/@/api/sell/sellCommunity';
import { submitForm } from '/@/utils/form';
import { rule } from './rule';
export default {
	name: 'editSellCommunity',
	setup() {
		const form = ref();
