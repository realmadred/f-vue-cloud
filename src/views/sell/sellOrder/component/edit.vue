<template>
	<div class="add-SellOrder-container">
		<el-dialog title="编辑订单" v-model="isShowDialog" width="756px">
				...
				<el-row :gutter="35">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="订单金额" prop="amount">
							<el-input-number v-model="ruleForm.amount" :step="0.01" placeholder="请输入订单金额" :min="0.00" :max="99999999" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="优惠金额" prop="discountAmount">
							<el-input-number v-model="ruleForm.discountAmount" :step="0.01" placeholder="请输入优惠金额" :min="0.00" :max="99999999" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="首付金额" prop="payAmount">
							<el-input-number v-model="ruleForm.payAmount" :step="0.01" placeholder="请输入首付金额" :min="0.00" :max="99999999" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="尾款金额" prop="lastPayAmount">
							<el-input-number v-model="ruleForm.lastPayAmount" :step="0.01" placeholder="请输入尾款金额" :min="0.00" :max="99999999" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
...
import { update, SellOrder } from '/@/api/sell/sellOrder';
